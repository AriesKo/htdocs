        ...
        <div id="grid">
            ...
            <div>
                ...
                <form action="process_update.py" method="post">
                    <input type="hidden" name="id" value="{form_default_title}">
                    <p><input type="text" name="title" placeholder="title" value="{form_default_title}"></p>
                    <p><textarea rows="4" name="descrption" placeholder="descrption">{form_default_descrption}</textarea></p>
...
'''
#print(htmlFormat)
print(htmlFormat.format(title=pageId, desc = description, listStr = getList(), img = img, form_default_title = pageId, form_default_descrption = description))
